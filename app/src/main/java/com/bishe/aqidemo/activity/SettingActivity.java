            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.front_navigation_menu_item:
                        Intent intentF = new Intent(SettingActivity.this, MainActivity.class);
                        intentF.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intentF);
                        break;
                    case R.id.list_navigation_menu_item:
                        Intent intentL = new Intent(SettingActivity.this, com.bishe.aqidemo.activity.ListActivity.class);
                        intentL.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intentL);
                        break;
                    case R.id.map_navigation_menu_item:
                        Intent intentM = new Intent(SettingActivity.this, MapActivity.class);
                    ...
                    case R.id.community_navigation_menu_item:
                        Intent intentC = new Intent(SettingActivity.this, CommunityActivity.class);
